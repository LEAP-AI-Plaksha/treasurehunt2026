"""
Multi-metric image similarity scoring engine for the Memory Forgery room.
Scores a generated reconstruction against the original photo across three
dimensions:
...
Ported from Memory-to-Image-Code/scoring.py so the kiosk backend can grade
H2_LOUNGE itself, rather than accepting any description unconditionally.
"""
...
print(f"[scoring] Loading CLIP model: {CLIP_MODEL_NAME} ...")
try:
